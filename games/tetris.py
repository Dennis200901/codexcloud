...
class TetrisGame:
    ...
    def draw_next_piece(self):
        label = self.font.render("Nächstes", True, NEON_BLUE)
    ...
    def draw_sidebar(self):
        lines_text = self.font.render(f"Linien: {self.lines_cleared}", True, NEON_BLUE)
    ...
    def draw(self):
        self.screen.fill((12, 6, 32))
        self._draw_neon_panel()
        self.draw_board()
    ...
    def _draw_neon_panel(self):
        ...
        pygame.draw.rect(self.screen, (30, 15, 60), panel_rect, border_radius=20)
        pygame.draw.rect(self.screen, NEON_PURPLE, panel_rect, width=4, border_radius=20)
        sidebar_rect = pygame.Rect(
            self.offset_x + self.play_width + 20,
            self.offset_y - 20,
            self.block_size * 6,
            self.play_height + 40,
        )
        pygame.draw.rect(self.screen, (18, 10, 45), sidebar_rect, border_radius=20)
        pygame.draw.rect(self.screen, NEON_PINK, sidebar_rect, width=3, border_radius=20)
